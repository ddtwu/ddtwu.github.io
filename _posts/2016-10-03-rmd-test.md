...
{% highlight text %}
## Error in function_list[[k]](value): could not find function "tbl_dt"
{% endhighlight %}
...
{% highlight text %}
## Error in names(weatherDate) <- tbNames: object 'weatherDate' not found
{% endhighlight %}
...
{% highlight text %}
## Error in names(weatherMonth) <- tbNames: object 'weatherMonth' not found
{% endhighlight %}
